...
- Firebase App Hosting + Firestore live sync + Vertex AI + BigQuery full-stack architecture
...
- Firestore sync, hosted Gemini support, and BigQuery analytics are active in the production deployment, while deterministic fallbacks preserve demo reliability.
